export default {
  ...
  auth: {
    ...
    pinHint: 'PIN must be 4-8 characters.',
    fillAllFields: 'Please fill all fields.',
    pinLength: 'New PIN must be 4-8 characters.',
    ...
    pinChangedBang: 'PIN changed successfully!',
  },
  ...
  materials: {
    ...
    sendConfirm: 'Send {{count}} item(s) to {{dest}}?',
    procurementDept: 'Procurement department',
    cannotDelete: 'Cannot Delete',
    minOneItem: 'At least one item is required.',
    removeItem: 'Remove Item',
    removeItemConfirm: 'Remove "{{name}}"?',
    remove: 'Remove',
    noDestination: 'No Destination',
    chooseDestination: 'Choose a supplier or send to procurement.',
    sendFailed: 'Failed to send.',
    mergedItems: 'Merged Items',
    sendOrderCount: 'Send Order ({{count}} items)',
    mergeSendConfirm: 'Merge {{requests}} request(s) · {{items}} item(s)\nSend to: {{dest}}',
    mergeSendCount: 'Merge & Send ({{count}} requests)',
  },
  ...
  tasks: {
    ...
    sendFailed: 'Failed to send task.',
    selectedCount: '{{count}} selected',
    recipientCount: 'Task sent to {{count}} recipient(s).',
    newTask: 'New Task',
  ...
  hub: {
    ...
    photoPermission: 'Please allow photo access to attach a completion image.',
