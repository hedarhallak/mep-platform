...
export default function DashboardScreen() {
  ...
  const ALL_MODULES: Module[] = [
    ...
    { id: 'standup', label: t('modules.standup'), icon: 'people-outline', color: '#059669', bg: '#ecfdf5', screen: 'Standup', perms: [['standup', 'manage']] },
    { id: 'project_staffing', label: t('modules.projectStaffing'), icon: 'people-circle-outline', color: '#8b5cf6', bg: '#f5f3ff', screen: 'ProjectStaffing', perms: [['assignments', 'view'], ['assignments', 'edit']] },
    { id: 'employees', label: t('modules.employees'), icon: 'person-circle-outline', color: '#3b82f6', bg: '#eff6ff', screen: 'Employees', perms: [['employees', 'view']] },
    { id: 'suppliers', label: t('modules.suppliers'), icon: 'storefront-outline', color: '#f97316', bg: '#fff7ed', screen: 'Suppliers', perms: [['suppliers', 'view']] },
    { id: 'projects', label: t('modules.projects'), icon: 'folder-outline', color: '#06b6d4', bg: '#ecfeff', screen: 'Projects', perms: [['projects', 'view']] },
