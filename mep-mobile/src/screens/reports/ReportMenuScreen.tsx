...
export default function ReportMenuScreen() {
  ...
  const items: SubMenuItem[] = [
    { id: 'this_week', label: t('report.thisWeek'), description: t('report.thisWeekDesc'), icon: 'today-outline', color: '#1e3a5f', bg: '#eff6ff', screen: 'ReportView', params: { period: 'this_week' } },
