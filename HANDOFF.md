...
> • **DEPLOY STATE:** prod was last deployed at SHA `6f1bff2` (after #387). **#388 + #389 are merged but NOT yet deployed** — run `bash /var/www/mep/scripts/deploy.sh` (frontend rebuild, Pitfall #41) to make Method 4 live. **Latest migration ON PROD = 033; latest in repo = 034 (not yet applied).** Only `HANDOFF.md` was the loose end this session (now this file).
