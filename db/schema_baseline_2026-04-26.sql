...
\restrict CBTU06o6Gacc2UatabpfMP2u2sEDdw0e6duepgBYueLFxB8nfDnqMFiMMeoG1j0
...
--
-- Name: erp; Type: SCHEMA; Schema: -; Owner: mepuser
--

CREATE SCHEMA erp;


ALTER SCHEMA erp OWNER TO mepuser;
...
--
-- Name: haversine_km(double precision, double precision, double precision, double precision); Type: FUNCTION; Schema: erp; Owner: mepuser
--

CREATE FUNCTION erp.haversine_km(lat1 double precision, lon1 double precision, lat2 double precision, lon2 double precision) RETURNS double precision
...
ALTER FUNCTION erp.haversine_km(lat1 double precision, lon1 double precision, lat2 double precision, lon2 double precision) OWNER TO mepuser;

--
-- Name: tg_set_updated_at(); Type: FUNCTION; Schema: erp; Owner: mepuser
--

CREATE FUNCTION erp.tg_set_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  NEW.updated_at := now();
...
ALTER FUNCTION erp.tg_set_updated_at() OWNER TO mepuser;
...
BEGIN
  ...
  WHERE employee_id = NEW.id
    AND contact_email IS DISTINCT FROM NEW.contact_email;
  RETURN NEW;
END;
$$;
...
--
-- Name: employee_projects; Type: TABLE; Schema: erp; Owner: mepuser
--

CREATE TABLE erp.employee_projects (
...
ALTER TABLE erp.employee_projects OWNER TO mepuser;

--
-- Name: employees; Type: TABLE; Schema: erp; Owner: mepuser
--
...
ALTER TABLE erp.employees OWNER TO mepuser;

--
-- Name: employees_id_seq; Type: SEQUENCE; Schema: erp; Owner: mepuser
--
...
ALTER SEQUENCE erp.employees_id_seq OWNER TO mepuser;

--
-- Name: employees_id_seq; Type: SEQUENCE OWNED BY; Schema: erp; Owner: mepuser
--
...
--
-- Name: projects; Type: TABLE; Schema: erp; Owner: mepuser
--
...
ALTER TABLE erp.projects OWNER TO mepuser;

--
-- Name: projects_id_seq; Type: SEQUENCE; Schema: erp; Owner: mepuser
--

CREATE SEQUENCE erp.projects_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE erp.projects_id_seq OWNER TO mepuser;

--
-- Name: projects_id_seq; Type: SEQUENCE OWNED BY; Schema: erp; Owner: mepuser
--

ALTER SEQUENCE erp.projects_id_seq OWNED BY erp.projects.id;


--
-- Name: work_logs; Type: TABLE; Schema: erp; Owner: mepuser
--

CREATE TABLE erp.work_logs (
    id integer NOT NULL,
    employee_id integer NOT NULL,
    project_id integer NOT NULL,
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT chk_lat_range CHECK (((latitude IS NULL) OR ((latitude >= ('-90'::integer)::double precision) AND (latitude <= (90)::double precision)))),
    CONSTRAINT chk_lon_range CHECK (((longitude IS NULL) OR ((longitude >= ('-180'::integer)::double precision) AND (longitude <= (180)::double precision)))),
    CONSTRAINT chk_work_logs_time_order CHECK (((check_out_time IS NULL) OR (check_in_time IS NULL) OR (check_out_time >= check_in_time)))
);


ALTER TABLE erp.work_logs OWNER TO mepuser;

--
-- Name: v_active_work_sessions; Type: VIEW; Schema: erp; Owner: mepuser
--

CREATE VIEW erp.v_active_work_sessions AS
 SELECT id,
    employee_id,
    project_id,
    check_in_time,
...
ALTER VIEW erp.v_active_work_sessions OWNER TO mepuser;

--
-- Name: v_latest_work_location; Type: VIEW; Schema: erp; Owner: mepuser
--

CREATE VIEW erp.v_latest_work_location AS
 SELECT DISTINCT ON (employee_id, project_id) employee_id,
    project_id,
    latitude,
    longitude,
    created_at
   FROM erp.work_logs
  ORDER BY employee_id, project_id, created_at DESC;


ALTER VIEW erp.v_latest_work_location OWNER TO mepuser;

--
-- Name: work_logs_id_seq; Type: SEQUENCE; Schema: erp; Owner: mepuser
--

CREATE SEQUENCE erp.work_logs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE erp.work_logs_id_seq OWNER TO mepuser;

--
-- Name: work_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: erp; Owner: mepuser
--

ALTER SEQUENCE erp.work_logs_id_seq OWNED BY erp.work_logs.id;
...
--
-- Name: materials_request_items; Type: TABLE; Schema: public; Owner: mepuser
--

CREATE TABLE public.materials_request_items (
    id bigint NOT NULL,
    request_id bigint NOT NULL,
    ...
    note text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT materials_request_items_qty_check CHECK ((qty > (0)::numeric))
);


ALTER TABLE public.materials_request_items OWNER TO mepuser;

--
-- Name: materials_request_items_id_seq; Type: SEQUENCE; Schema: public; Owner: mepuser
--

CREATE SEQUENCE public.materials_request_items_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.materials_request_items_id_seq OWNER TO mepuser;

--
-- Name: materials_request_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mepuser
--

ALTER SEQUENCE public.materials_request_items_id_seq OWNED BY public.materials_request_items.id;


--
-- Name: materials_requests; Type: TABLE; Schema: public; Owner: mepuser
--
...
CREATE TABLE public.materials_requests (
    ...
    submitted_at timestamp with time zone DEFAULT now() NOT NULL,
    foreman_employee_id bigint,
    foreman_routed_at timestamp with time zone,
    note text
);


ALTER TABLE public.materials_requests OWNER TO mepuser;

--
-- Name: materials_requests_id_seq; Type: SEQUENCE; Schema: public; Owner: mepuser
--

CREATE SEQUENCE public.materials_requests_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.materials_requests_id_seq OWNER TO mepuser;

--
-- Name: materials_requests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mepuser
--

ALTER SEQUENCE public.materials_requests_id_seq OWNED BY public.materials_requests.id;


--
-- Name: materials_ticket_items; Type: TABLE; Schema: public; Owner: mepuser
--

CREATE TABLE public.materials_ticket_items (
    id integer NOT NULL,
    ...
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    CONSTRAINT materials_ticket_items_source_check CHECK ((source = ANY (ARRAY['WORKER'::text, 'FOREMAN'::text])))
);


ALTER TABLE public.materials_ticket_items OWNER TO mepuser;

--
-- Name: materials_ticket_items_id_seq; Type: SEQUENCE; Schema: public; Owner: mepuser
--

CREATE SEQUENCE public.materials_ticket_items_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.materials_ticket_items_id_seq OWNER TO mepuser;

--
-- Name: materials_ticket_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mepuser
--

ALTER SEQUENCE public.materials_ticket_items_id_seq OWNED BY public.materials_ticket_items.id;


--
-- Name: materials_tickets; Type: TABLE; Schema: public; Owner: mepuser
--

CREATE TABLE public.materials_tickets (
    id integer NOT NULL,
    work_date date NOT NULL,
    project_id integer NOT NULL,
    ...
    CONSTRAINT materials_tickets_status_check CHECK ((status = ANY (ARRAY['DRAFT'::text, 'SENT_TO_OFFICE'::text])))
);


ALTER TABLE public.materials_tickets OWNER TO mepuser;

--
-- Name: materials_tickets_id_seq; Type: SEQUENCE; Schema: public; Owner: mepuser
--

CREATE SEQUENCE public.materials_tickets_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.materials_tickets_id_seq OWNER TO mepuser;

--
-- Name: materials_tickets_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mepuser
--

ALTER SEQUENCE public.materials_tickets_id_seq OWNED BY public.materials_tickets.id;
...
--
-- Name: employees id; Type: DEFAULT; Schema: erp; Owner: mepuser
--
...
--
-- Name: projects id; Type: DEFAULT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.projects ALTER COLUMN id SET DEFAULT nextval('erp.projects_id_seq'::regclass);


--
-- Name: work_logs id; Type: DEFAULT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.work_logs ALTER COLUMN id SET DEFAULT nextval('erp.work_logs_id_seq'::regclass);
...
--
-- Name: materials_request_items id; Type: DEFAULT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_request_items ALTER COLUMN id SET DEFAULT nextval('public.materials_request_items_id_seq'::regclass);


--
-- Name: materials_requests id; Type: DEFAULT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_requests ALTER COLUMN id SET DEFAULT nextval('public.materials_requests_id_seq'::regclass);


--
-- Name: materials_ticket_items id; Type: DEFAULT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_ticket_items ALTER COLUMN id SET DEFAULT nextval('public.materials_ticket_items_id_seq'::regclass);


--
-- Name: materials_tickets id; Type: DEFAULT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_tickets ALTER COLUMN id SET DEFAULT nextval('public.materials_tickets_id_seq'::regclass);
...
--
-- Name: employee_projects employee_projects_pkey; Type: CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.employee_projects
    ADD CONSTRAINT employee_projects_pkey PRIMARY KEY (employee_id, project_id);


--
-- Name: employees employees_email_key; Type: CONSTRAINT; Schema: erp; Owner: mepuser
--
...
--
-- Name: employees employees_pkey; Type: CONSTRAINT; Schema: erp; Owner: mepuser
--
...
--
-- Name: projects projects_pkey; Type: CONSTRAINT; Schema: erp; Owner: mepuser
--
...
--
-- Name: employee_projects uq_employee_projects_employee_project; Type: CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.employee_projects
    ADD CONSTRAINT uq_employee_projects_employee_project UNIQUE (employee_id, project_id);


--
-- Name: work_logs work_logs_pkey; Type: CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.work_logs
...
--
-- Name: materials_request_items materials_request_items_pkey; Type: CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_request_items
    ADD CONSTRAINT materials_request_items_pkey PRIMARY KEY (id);


--
-- Name: materials_requests materials_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_requests
    ADD CONSTRAINT materials_requests_pkey PRIMARY KEY (id);


--
-- Name: materials_ticket_items materials_ticket_items_pkey; Type: CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_ticket_items
    ADD CONSTRAINT materials_ticket_items_pkey PRIMARY KEY (id);


--
-- Name: materials_tickets materials_tickets_pkey; Type: CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_tickets
    ADD CONSTRAINT materials_tickets_pkey PRIMARY KEY (id);


--
-- Name: materials_tickets materials_tickets_work_date_project_id_key; Type: CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_tickets
    ADD CONSTRAINT materials_tickets_work_date_project_id_key UNIQUE (work_date, project_id);
...
--
-- Name: idx_employee_projects_employee; Type: INDEX; Schema: erp; Owner: mepuser
--

CREATE INDEX idx_employee_projects_employee ON erp.employee_projects USING btree (employee_id);


--
-- Name: idx_employee_projects_employee_id; Type: INDEX; Schema: erp; Owner: mepuser
--

CREATE INDEX idx_employee_projects_employee_id ON erp.employee_projects USING btree (employee_id);


--
-- Name: idx_employee_projects_project; Type: INDEX; Schema: erp; Owner: mepuser
--

CREATE INDEX idx_employee_projects_project ON erp.employee_projects USING btree (project_id);


--
-- Name: idx_employee_projects_project_id; Type: INDEX; Schema: erp; Owner: mepuser
--

CREATE INDEX idx_employee_projects_project_id ON erp.employee_projects USING btree (project_id);


--
-- Name: idx_work_logs_check_in_time; Type: INDEX; Schema: erp; Owner: mepuser
--

CREATE INDEX idx_work_logs_check_in_time ON erp.work_logs USING btree (check_in_time);


--
-- Name: idx_work_logs_employee_id; Type: INDEX; Schema: erp; Owner: mepuser
--

CREATE INDEX idx_work_logs_employee_id ON erp.work_logs USING btree (employee_id);


--
-- Name: idx_work_logs_open_shifts; Type: INDEX; Schema: erp; Owner: mepuser
--

CREATE INDEX idx_work_logs_open_shifts ON erp.work_logs USING btree (employee_id, project_id) WHERE (check_out_time IS NULL);


--
-- Name: idx_work_logs_project_id; Type: INDEX; Schema: erp; Owner: mepuser
--

CREATE INDEX idx_work_logs_project_id ON erp.work_logs USING btree (project_id);


--
-- Name: ux_work_logs_one_open_session; Type: INDEX; Schema: erp; Owner: mepuser
--

CREATE UNIQUE INDEX ux_work_logs_one_open_session ON erp.work_logs USING btree (employee_id, project_id) WHERE (check_out_time IS NULL);
...
--
-- Name: idx_materials_items_request; Type: INDEX; Schema: public; Owner: mepuser
--

CREATE INDEX idx_materials_items_request ON public.materials_request_items USING btree (request_id);


--
-- Name: idx_materials_requests_foreman_date; Type: INDEX; Schema: public; Owner: mepuser
--

CREATE INDEX idx_materials_requests_foreman_date ON public.materials_requests USING btree (foreman_employee_id, work_date);


--
-- Name: idx_materials_requests_project_date; Type: INDEX; Schema: public; Owner: mepuser
--

CREATE INDEX idx_materials_requests_project_date ON public.materials_requests USING btree (project_id, work_date);
...
--
-- Name: employee_projects employee_projects_set_updated_at; Type: TRIGGER; Schema: erp; Owner: mepuser
--

CREATE TRIGGER employee_projects_set_updated_at BEFORE UPDATE ON erp.employee_projects FOR EACH ROW EXECUTE FUNCTION erp.tg_set_updated_at();


--
-- Name: employees employees_set_updated_at; Type: TRIGGER; Schema: erp; Owner: mepuser
--

CREATE TRIGGER employees_set_updated_at BEFORE UPDATE ON erp.employees FOR EACH ROW EXECUTE FUNCTION erp.tg_set_updated_at();


--
-- Name: projects projects_set_updated_at; Type: TRIGGER; Schema: erp; Owner: mepuser
--

CREATE TRIGGER projects_set_updated_at BEFORE UPDATE ON erp.projects FOR EACH ROW EXECUTE FUNCTION erp.tg_set_updated_at();


--
-- Name: work_logs work_logs_set_updated_at; Type: TRIGGER; Schema: erp; Owner: mepuser
--

CREATE TRIGGER work_logs_set_updated_at BEFORE UPDATE ON erp.work_logs FOR EACH ROW EXECUTE FUNCTION erp.tg_set_updated_at();
...
--
-- Name: employee_projects employee_projects_employee_id_fkey; Type: FK CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.employee_projects
    ADD CONSTRAINT employee_projects_employee_id_fkey FOREIGN KEY (employee_id) REFERENCES erp.employees(id) ON DELETE CASCADE;


--
-- Name: employee_projects employee_projects_project_id_fkey; Type: FK CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.employee_projects
    ADD CONSTRAINT employee_projects_project_id_fkey FOREIGN KEY (project_id) REFERENCES erp.projects(id) ON DELETE CASCADE;


--
-- Name: employee_projects fk_employee_projects_employee; Type: FK CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.employee_projects
    ADD CONSTRAINT fk_employee_projects_employee FOREIGN KEY (employee_id) REFERENCES erp.employees(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: employee_projects fk_employee_projects_project; Type: FK CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.employee_projects
    ADD CONSTRAINT fk_employee_projects_project FOREIGN KEY (project_id) REFERENCES erp.projects(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: work_logs fk_work_logs_employee; Type: FK CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.work_logs
    ADD CONSTRAINT fk_work_logs_employee FOREIGN KEY (employee_id) REFERENCES erp.employees(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: work_logs fk_work_logs_project; Type: FK CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.work_logs
    ADD CONSTRAINT fk_work_logs_project FOREIGN KEY (project_id) REFERENCES erp.projects(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: work_logs work_logs_employee_id_fkey; Type: FK CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.work_logs
    ADD CONSTRAINT work_logs_employee_id_fkey FOREIGN KEY (employee_id) REFERENCES erp.employees(id) ON DELETE CASCADE;


--
-- Name: work_logs work_logs_project_id_fkey; Type: FK CONSTRAINT; Schema: erp; Owner: mepuser
--

ALTER TABLE ONLY erp.work_logs
    ADD CONSTRAINT work_logs_project_id_fkey FOREIGN KEY (project_id) REFERENCES erp.projects(id) ON DELETE CASCADE;
...
--
-- Name: materials_request_items materials_request_items_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_request_items
    ADD CONSTRAINT materials_request_items_request_id_fkey FOREIGN KEY (request_id) REFERENCES public.materials_requests(id) ON DELETE CASCADE;


--
-- Name: materials_requests materials_requests_created_by_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_requests
    ADD CONSTRAINT materials_requests_created_by_employee_id_fkey FOREIGN KEY (created_by_employee_id) REFERENCES public.employees(id) ON DELETE RESTRICT;


--
-- Name: materials_requests materials_requests_created_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_requests
    ADD CONSTRAINT materials_requests_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.app_users(id) ON DELETE RESTRICT;


--
-- Name: materials_requests materials_requests_foreman_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_requests
    ADD CONSTRAINT materials_requests_foreman_employee_id_fkey FOREIGN KEY (foreman_employee_id) REFERENCES public.employees(id) ON DELETE RESTRICT;


--
-- Name: materials_requests materials_requests_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_requests
    ADD CONSTRAINT materials_requests_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE RESTRICT;


--
-- Name: materials_ticket_items materials_ticket_items_source_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_ticket_items
    ADD CONSTRAINT materials_ticket_items_source_request_id_fkey FOREIGN KEY (source_request_id) REFERENCES public.materials_requests(id) ON DELETE SET NULL;


--
-- Name: materials_ticket_items materials_ticket_items_ticket_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_ticket_items
    ADD CONSTRAINT materials_ticket_items_ticket_id_fkey FOREIGN KEY (ticket_id) REFERENCES public.materials_tickets(id) ON DELETE CASCADE;


--
-- Name: materials_tickets materials_tickets_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: mepuser
--

ALTER TABLE ONLY public.materials_tickets
    ADD CONSTRAINT materials_tickets_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE RESTRICT;
...
\unrestrict CBTU06o6Gacc2UatabpfMP2u2sEDdw0e6duepgBYueLFxB8nfDnqMFiMMeoG1j0
