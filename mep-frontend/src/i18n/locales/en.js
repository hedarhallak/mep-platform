...
export default {
  ...
  crews: {
    ...
    modal: {
      ...
      searchMembers: 'Search employees…',
  ...
  projectStaffing: {
    ...
    subtitle: 'See what each project needs vs who is assigned — and fill the gaps',
    selectProject: 'Select a project…',
    pickToStart: 'Pick a project to see its staffing.',
    coverageOn: 'Coverage on {{date}}',
    totalsLine: 'Total required {{required}} · assigned {{assigned}}',
    noCoverage: 'No requirements set for this date.',
    reqVsAsg: 'required {{required}} · assigned {{assigned}}',
    short: 'short {{n}}',
    over: 'over {{n}}',
    covered: 'covered',
    ...
    modal: {
      ...
      to: 'To',
      note: 'Note',
      notePlaceholder: 'e.g. rough-in phase',
      cancel: 'Cancel',
      add: 'Add',
      update: 'Save',
  ...
  assignments: {
    ...
    wizard: {
      ...
      q1: 'For which day?',
      q2: 'On what basis?',
      q3: 'Which optimizations?',
      basis: {
        repeat: 'Repeat today',
        repeatHint: 'Carry today’s crews over to the target date — no new sites opened.',
      ...
      opt: {
        ...
        gaps: 'Fill gaps with replacements',
        gapsHint: 'When someone is busy elsewhere, suggest an available same-trade replacement.',
      },
      allowanceTotal: 'Estimated travel allowances: {{amount}}/day',
      allowanceHint: 'CCQ rates · road distance estimated from home↔site (~×1.3)',
      keptCount: '{{count}} in plan',
      day: 'day',
      noProjects: 'Nothing to plan for this date',
    ...
    optimize: {
      banner: '{{count}} optimization suggestion(s) — save ~{{km}} km of travel',
      show: 'Review',
      hide: 'Hide',
      apply: 'Apply',
    },
