...
export default {
  ...
  nav: {
    ...
    crews: 'Équipes',
    projectStaffing: 'Effectifs par projet',
  ...
  crews: {
    ...
    modal: {
      ...
      searchMembers: 'Rechercher des employés…',
  ...
  projectStaffing: {
    title: 'Effectifs par projet',
    subtitle: 'Voyez ce que chaque projet exige vs qui est affecté — et comblez les écarts',
    selectProject: 'Choisir un projet…',
    pickToStart: 'Choisissez un projet pour voir ses effectifs.',
    coverageOn: 'Couverture le {{date}}',
    totalsLine: 'Total requis {{required}} · affectés {{assigned}}',
    noCoverage: 'Aucune exigence définie pour cette date.',
    reqVsAsg: 'requis {{required}} · affectés {{assigned}}',
    short: 'manque {{n}}',
    over: 'surplus {{n}}',
    covered: 'comblé',
    ...
    modal: {
      ...
      to: 'Au',
      note: 'Note',
      notePlaceholder: 'ex. phase de tuyauterie brute',
      cancel: 'Annuler',
      add: 'Ajouter',
      update: 'Enregistrer',
      errors: { dateRange: 'La date de début doit précéder la date de fin' },
    },
  },
