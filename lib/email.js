...
async function sendSubscriptionInvoice({ to, invoice }) {
  ...
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p class="sub">Your monthly subscription invoice is ready${pdfBuffer ? ' (PDF attached)' : ''}.</p>
      <div class="info-box">
        <div class="row"><span class="label">Seats</span><span class="value">${seats} &times; $${unit}</span></div>
        <div class="row"><span class="label">Subtotal</span><span class="value">$${subtotal} CAD</span></div>
        <div class="row"><span class="label">QST</span><span class="value">$${qst} CAD</span></div>
        <div class="row"><span class="label">GST</span><span class="value">$${gst} CAD</span></div>
        <div class="row"><span class="label">Total</span><span class="value">$${total} CAD</span></div>
        <div class="row"><span class="label">Due</span><span class="value">${due}</span></div>
      </div>
