...
const AUTH_TAG_LENGTH = 16; // GCM standard tag length; required by Semgrep
// (javascript.node-crypto.security.gcm-no-tag-length)
// to prevent shorter-tag forgery attacks.
const STEP_SECONDS = 30;
const DIGITS = 6;
const WINDOW = 2; // ±2 steps = ±60s tolerance. RFC 6238 §5.2 allows up to ±1
// for "transmission delay"; many implementations (including
// Google's own) accept ±2 to absorb phone clock drift +
// typing latency. The marginal cost is one extra 30s of
// valid codes (still tiny vs 24h of brute force attempts).
